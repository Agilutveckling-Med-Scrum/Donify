<template>
  <div class="about">
    ...
    <h2>
      Donify är världens mest betrodda plattform online för insamling till
      välgörenhet
    </h2>
    <p>
      Donify hjälper organisationer att uppnå sina mål med hjälp av användarnas
      ekonomiska stöd. Donationstjänsten kan hjälpa samt stötta slutkunder i den
      breda skalan. Allt från att hjälpa samhällets mest utsatta med medicin,
      till ett nystartat företag att uppnå sin dröm. Donify samarbetar tätt med
      välkända välgörenhetsorganisationer och stämmer regelbundet av hur
      donationerna kommer till nytta.
    </p>
